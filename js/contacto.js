...
document.getElementById("comentario").addEventListener("keyup", limitar);
      document.getElementById("comentario").addEventListener("keydown", limitar);
...
function limitar(){
    ...
    if(tamaño > 100){
        cadena = cadena.substring(0, 100);
        tamaño = 100;
        document.getElementById("comentario").value = cadena;
    }

    objRestante.innerHTML = 100 - tamaño; 
